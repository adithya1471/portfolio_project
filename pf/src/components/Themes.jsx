...
import './themes.css'
import ThemeItem from "./Themetem";
import { FaCog } from "react-icons/fa";
import {BsSun, BsMoon} from "react-icons/bs"
import { useState } from "react";

const getSorageColor = ()=>{
...
const Themes = () =>{
    ...
    const [color, setColor] = useState(getSorageColor());
    const [theme, setTheme] =useState(getSorageTheme());
